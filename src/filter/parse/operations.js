...
export const parseOperations = (parseAttrs, { operations, throwErr }) => {
...
export const parseOperation = ({ type, value, throwErr, parseAttrs }) => {
...
const parseValue = ({ operator, type, value, throwErr, parseAttrs }) => {
