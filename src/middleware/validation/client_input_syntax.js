...
const rules = {
  findOne:      { allowed: ['order_by'],                            required: ['filter', 'filter.id'],                    },
  findMany:     { allowed: ['filter', 'filter.id', 'order_by'],     required: [],
                  idMultiple: true                                                                                        },
  deleteOne:    { allowed: ['order_by'],                            required: ['filter', 'filter.id']                     },
  deleteMany:   { allowed: ['filter', 'filter.id', 'order_by'],     required: [],
                  idMultiple: true                                                                                        },
  updateOne:    { allowed: ['order_by'],                            required: ['data', 'filter', 'filter.id'],
                                                                    forbidden: ['data.id']                                },
  updateMany:   { allowed: ['filter', 'filter.id', 'order_by'],     required: ['data'],
                  idMultiple: true,                                 forbidden: ['data.id']                                },
  upsertOne:    { allowed: ['order_by'],                            required: ['data', 'data.id']                         },
  upsertMany:   { allowed: ['order_by'],                            required: ['data', 'data.*.id'],
                  dataMultiple: true                                                                                      },
  replaceOne:   { allowed: ['order_by'],                            required: ['data', 'data.id']                         },
  replaceMany:  { allowed: ['order_by'],                            required: ['data', 'data.*.id'],
                  dataMultiple: true                                                                                      },
  createOne:    { allowed: ['data', 'order_by'],                    required: ['data']                                    },
