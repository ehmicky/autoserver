...
export const renameIdsInput = ({ dbAdapter: { idName }, args }) => {
...
// Revert changes
export const renameIdsOutput = ({ dbAdapter: { idName }, args, dbData }) => {
  if (idName === undefined) {
    return
  }
...
const renameArgs = ({ args, newIdName, oldIdName }) => {
...
const renameDbData = ({ dbData, newIdName, oldIdName }) => {
  if (dbData === undefined) {
    return
  }
